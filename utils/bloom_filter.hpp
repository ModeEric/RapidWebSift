...
public:
   ...
   void serialize(std::ostream& out) const {
    out.write(reinterpret_cast<const char*>(&salt_count_), sizeof(salt_count_));
    out.write(reinterpret_cast<const char*>(&table_size_), sizeof(table_size_));
    out.write(reinterpret_cast<const char*>(&projected_element_count_), sizeof(projected_element_count_));
    out.write(reinterpret_cast<const char*>(&inserted_element_count_), sizeof(inserted_element_count_));
    out.write(reinterpret_cast<const char*>(&random_seed_), sizeof(random_seed_));
    out.write(reinterpret_cast<const char*>(&desired_false_positive_probability_), sizeof(desired_false_positive_probability_));

    std::size_t salt_size = salt_.size();
    out.write(reinterpret_cast<const char*>(&salt_size), sizeof(salt_size));
    out.write(reinterpret_cast<const char*>(salt_.data()), salt_size * sizeof(bloom_type));

    std::size_t bit_table_size = bit_table_.size();
    out.write(reinterpret_cast<const char*>(&bit_table_size), sizeof(bit_table_size));
    out.write(reinterpret_cast<const char*>(bit_table_.data()), bit_table_size * sizeof(cell_type));
}

void deserialize(std::istream& in) {
    in.read(reinterpret_cast<char*>(&salt_count_), sizeof(salt_count_));
    in.read(reinterpret_cast<char*>(&table_size_), sizeof(table_size_));
    in.read(reinterpret_cast<char*>(&projected_element_count_), sizeof(projected_element_count_));
    in.read(reinterpret_cast<char*>(&inserted_element_count_), sizeof(inserted_element_count_));
    in.read(reinterpret_cast<char*>(&random_seed_), sizeof(random_seed_));
    in.read(reinterpret_cast<char*>(&desired_false_positive_probability_), sizeof(desired_false_positive_probability_));

    std::size_t salt_size;
    in.read(reinterpret_cast<char*>(&salt_size), sizeof(salt_size));
    salt_.resize(salt_size);
    in.read(reinterpret_cast<char*>(salt_.data()), salt_size * sizeof(bloom_type));

    std::size_t bit_table_size;
    in.read(reinterpret_cast<char*>(&bit_table_size), sizeof(bit_table_size));
    bit_table_.resize(bit_table_size);
    in.read(reinterpret_cast<char*>(bit_table_.data()), bit_table_size * sizeof(cell_type));
}
